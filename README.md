...
## Overview
This contains a comprehensive analysis of Netflix's catalog of movies and TV shows. The analysis includes data preparation, cleaning, exploration, visualization, and R integration using Python (Seaborn, Matplotlib, Pandas) and R.
